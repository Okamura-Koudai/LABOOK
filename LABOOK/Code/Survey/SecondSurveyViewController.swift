...
class SecondSurveyViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let email = Auth.auth().currentUser?.email {
            Firestore.firestore().collection("survey").document("secondSurvey").collection(surveyList[indexPath.row]).document(email).getDocument {(snapshot, err ) in
                if let err = err {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        VC.csvFileName = "SecondSurveyArray"
        VC.surveyName = "secondSurvey"
    ...
    override func viewDidLoad() {
        ...
        csvArray = loadCSV(fileName: "SecondSurveyArray")
